...
🏭 Scenario and Use Case: Scenario:

The manufacturing industry aims to reduce manual monitoring and increase efficiency through automation using IoT devices and embedded controllers. The system should:
...
Predictive Maintenance System in Smart Manufacturing (Using IoT sensors and AI analytics to detect machine faults early and prevent downtime.)
...
The various types of prompts were executed successfully using different AI tools. A rubric-based evaluation showed that ChatGPT and Claude were the most effective platforms for generating accurate, detailed, and context-aware responses for the manufacturing automation use case.
